...
package com.semanticcms.section.model.book;
...
@WebServlet("/section/model/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    HttpServletUtil.sendRedirect(
        ...
        "/section/model/apidocs/com.semanticcms.section.model/com" + Objects.toString(req.getPathInfo(), ""),
